function [ts, wd] = detStaircase(steps, weights, fflag)
% Creates a deterministic discrete staircase (see Muzy, 1994)
%
% Usage
%   [ts, wd] = randStaircase(7, [.5, 0, .5], 1);
%
% Inputs
...
%
    ...
    if fflag == 1
        figure;
        plot(ts, 'k');
        title('Generalized Deterministic Staircase', 'FontSize', 24);
